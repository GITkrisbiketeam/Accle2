 ...
 */
public class Register implements Parcelable, Cloneable{
	...
	Register(String short_label, int reg, String label){
		this.shortLabel = short_label;
		this.label = label;
		this.reg = reg;
	}
	Register(String shortLabel, int reg, String label, int val){
		this(shortLabel, reg, label);
		this.val = val;
	}
	Register(String shortLabel, int reg, String label, int val, boolean readOnly){
		this(shortLabel, reg, label, val);
		this.readOnly = readOnly;
	}
	Register(String shortLabel, int reg, String label, int val, boolean readOnly, int maxVal){
