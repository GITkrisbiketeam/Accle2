...
public class BlueMSP430SsensorsInfoTabActivity extends ListActivity{
...
//TODO sprawdziæ czemu nie dzia³a wpisanie wartoœci przez wciœniêcie ok albo gotowe
	...
	public void onListItemClick(ListView parent, View v, int position, long id) {
		...
		if(s != null){
	    	if(local_registers.get(position).getReg() == s.getCtrl()){
				Intent intent = new Intent(this, BlueMSP430SsensorsInfoTabActivity.class);
	...
	class RawAdapter extends ArrayAdapter<BlueMSP430_register> {
    	...
    	RawAdapter() {
    		super(BlueMSP430SsensorsInfoTabActivity.this, 
