...
public class BluetoothDeviceListActivity extends Activity {
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            //wyœlij Broadcasta z adresem urzadzenia bluetooth do pol¹czenia siê z
     ...
     * @param data Intent z adresem Bluetooth urz¹dzenia do pod³¹czenia siê
     */
    private void sendMyBroadcast(Intent data){
    	Intent broadcastIntent;
    	broadcastIntent = new Intent("BluetoothDeviceListActivity_Result");
    	broadcastIntent.putExtras(data);
    	//wysy³amy ogóle powiadomienie o zmianie stanu po³¹czenia
